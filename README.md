...
to 10–150 characters with no ASCII punctuation, whitespace, combining marks or
non-underscore connector punctuation (the backend applies the precise `\w`
rule to anything else) — because the match goes
