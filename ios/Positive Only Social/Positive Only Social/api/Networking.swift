...
protocol Networking {
    ...
    /// (#307). A nil `audience` defaults to public (issue #392).
    func makePost(sessionManagementToken: String, imageURL: String?, caption: String, audience: String?) async throws -> Data
