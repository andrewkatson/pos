...
final class StatefulStubbedAPI: Networking {
    ...
    func getPostDetails(sessionManagementToken: String, postIdentifier: String) async throws -> Data {
        ...
        struct Fields: Codable { let post_identifier: String; let image_url: String?; let caption: String; let creation_time: String; let post_likes: Int; let is_liked: Bool; let author_username: String }
