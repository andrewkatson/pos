# Generated by Django 5.2.5 on 2025-10-10 03:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_thread', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_system.commentthread')),
            ],
        ),
        migrations.CreateModel(
            name='CommentReport',
        ...
        migrations.AddField(
            ...
            name='following',
            field=models.ManyToManyField(through='user_system.UserFollow', through_fields=('user_from', 'user_to'), to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='CommentLike',
            fields=[
