    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(default=user_system.models.Comment.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to='user_system.comment')),
            ],
        ),
        migrations.CreateModel(
            name='CommentReport',
        ...
        migrations.AddField(
            model_name='comment',
            name='comment_thread',
            field=models.ForeignKey(default=user_system.models.CommentThread.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to='user_system.commentthread'),
        ),
        migrations.CreateModel(
            name='LoginCookie',
            fields=[
                ...
                ('cookie_user', models.ForeignKey(default=user_system.models.PositiveOnlySocialUser.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('reported_by_username', models.TextField(null=True)),
                ('hidden', models.BooleanField(default=False)),
                ('author', models.ForeignKey(default=user_system.models.PositiveOnlySocialUser.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='commentthread',
            name='post',
            field=models.ForeignKey(default=user_system.models.Post.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to='user_system.post'),
        ),
        migrations.CreateModel(
            name='PostLike',
            fields=[
                ...
                ('post', models.ForeignKey(default=user_system.models.PositiveOnlySocialUser.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to='user_system.post')),
            ],
        ),
        migrations.CreateModel(
            name='PostReport',
            fields=[
                ...
                ('creation_time', models.DateTimeField(auto_now=True, null=True)),
                ('reason', models.TextField(null=True)),
                ('post', models.ForeignKey(default=user_system.models.Post.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to='user_system.post')),
            ],
        ),
        migrations.CreateModel(
            name='Session',
            fields=[
                ...
                ('management_user', models.ForeignKey(default=user_system.models.PositiveOnlySocialUser.get_default_pk, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
