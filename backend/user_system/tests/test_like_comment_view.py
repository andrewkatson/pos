...
class LikeCommentTests(PositiveOnlySocialTestCase):
    ...
    def test_invalid_session_management_token_returns_bad_response(self):
        ...
        response = like_comment(self.like_comment_request, invalid_session_management_token, str(self.post_identifier),
    ...
    def test_invalid_post_identifier_returns_bad_response(self):
        # Test view like_comment
        response = like_comment(self.like_comment_request, self.liker_session_management_token, invalid_post_identifier,
                                str(self.comment_thread_identifier), str(self.comment_identifier))
        self.assertEqual(response.status_code, FAIL)
    ...
    def test_like_comment_returns_good_response_and_likes_comment_from_user(self):
        # Test view like_comment
        response = like_comment(self.like_comment_request, self.liker_session_management_token,
                                str(self.post_identifier), str(self.comment_thread_identifier),
                                str(self.comment_identifier))
